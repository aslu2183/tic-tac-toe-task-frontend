...
import { login as LoginDispatch } from 'src/redux/Reducers/authenticate'
    ...
    <Box className='content-center'>
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <form validate="true" autoComplete='off' onSubmit={(e) => {
              e.preventDefault()
              tryLogin()
            }}>
            <TextField autoFocus fullWidth id='email' label='Email' sx={{ marginBottom: 4 }} onChange={handleChange('email')} required={true} type="email"/>
